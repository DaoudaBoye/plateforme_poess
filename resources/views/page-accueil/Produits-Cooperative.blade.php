...
<section class="products-hero">
  <div class="container position-relative">
    ...
    <h1 class="display-4 fw-bold mb-3" id="heroTitle">Nos Produits</h1>
        ...
        <div class="col-lg-8">
          <div class="d-flex align-items-start flex-wrap mb-4">
            ...
            <div class="flex-grow-1">
              <h3 class="fw-bold mb-2" id="coopName">Coopérative</h3>
              <p class="text-muted mb-3" id="coopLocation"><i class="bi bi-geo-alt me-2"></i>Localisation</p>
              <div id="coopDescription">
        ...
        <div class="col-lg-4">
          ...
          <div class="contact-section">
            ...
            <div class="contact-cta">
              <h5><i class="bi bi-chat-dots me-2"></i>Intéressé(e) ?</h5>
...
const cooperativesData = {
  'Coopérative Agricole Diamniadio': {
    ...
    products: [
      { name: 'Riz Bio Premium', price: 2500, unit: 'kg', category: 'Céréales', stock: 'En stock', icon: 'bi-basket', description: 'Riz bio de première qualité, cultivé sans pesticides' },
      { name: 'Mil Local', price: 1800, unit: 'kg', category: 'Céréales', stock: 'En stock', icon: 'bi-basket', description: 'Mil traditionnel sénégalais' },
      { name: 'Maïs Bio', price: 2000, unit: 'kg', category: 'Céréales', stock: 'En stock', icon: 'bi-basket', description: 'Maïs biologique certifié' },
      { name: 'Arachide de bouche', price: 3200, unit: 'kg', category: 'Légumineuses', stock: 'Stock limité', icon: 'bi-basket', description: 'Arachides sélectionnées pour leur qualité' },
      { name: 'Huile d\'arachide', price: 4500, unit: 'L', category: 'Huiles', stock: 'En stock', icon: 'bi-droplet', description: 'Huile pure pressée à froid' },
      { name: 'Fonio Bio', price: 3500, unit: 'kg', category: 'Céréales', stock: 'En stock', icon: 'bi-basket', description: 'Céréale ancestrale riche en nutriments' },
      { name: 'Niébé', price: 2200, unit: 'kg', category: 'Légumineuses', stock: 'En stock', icon: 'bi-basket', description: 'Haricots locaux nutritifs' },
      { name: 'Sorgho', price: 1900, unit: 'kg', category: 'Céréales', stock: 'Stock limité', icon: 'bi-basket', description: 'Sorgho rouge de qualité' },
      { name: 'Sésame', price: 2800, unit: 'kg', category: 'Graines', stock: 'En stock', icon: 'bi-basket', description: 'Graines de sésame premium' },
      { name: 'Bissap (Hibiscus)', price: 1500, unit: 'kg', category: 'Infusions', stock: 'En stock', icon: 'bi-flower1', description: 'Fleurs séchées pour infusions' },
      { name: 'Gombo séché', price: 2100, unit: 'kg', category: 'Légumes', stock: 'En stock', icon: 'bi-basket', description: 'Gombo séché naturellement' },
      { name: 'Poudre de baobab', price: 3800, unit: 'kg', category: 'Super-aliments', stock: 'Stock limité', icon: 'bi-tree', description: 'Poudre de pain de singe riche en vitamine C' }
    ]
  },
