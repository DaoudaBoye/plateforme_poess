...
<nav class="main-header navbar navbar-expand fixed-top" style="background-color: #57b44b;">
    <ul class="navbar-nav">
        <li class="nav-item">
        ...
        <li class="nav-item flex-grow-1 text-center text-lg-start">
            <a class="nav-link text-black" href="#" role="button">
                <strong class="h6 d-block d-lg-inline text-wrap">
                    <strong class="d-inline d-lg-none">POESS</strong>
                    <strong class="d-none d-lg-inline">Plateforme numérique des organisations de l’ESS</strong>
                </strong>
            </a>
        </li>
